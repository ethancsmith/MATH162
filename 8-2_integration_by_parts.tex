...
\lectureheader{162}{Calculus II}{Integration by parts}{\textit{Thomas' Calculus}  8.2}
...
If I know how to differentiate a function, but not how to integrate it, maybe integration by parts can help.
\end{itemize}
\end{remark}
...
\begin{remark}
Integration by parts works for definite integral as well so long as you remember to evaluate and substract appropriately.
