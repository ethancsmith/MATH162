...
\end{split}
\end{equation*}
By RaT, the power series converges absolutely if and only if $\rho=|2x+3|<1$.
...
Therefore, the interval of absolute convergence is $(-2,-1)$.
...
\end{equation*}
converges since it is equal to the alternating harmonic series which we know converges.
...
= |x|.
\end{equation*}
By RaT, the power series converges absolutely if and only if $|x|<1$, i.e., $x\in (-1,1)$.
At $x=1$,
\begin{equation*}
...
=-\sum_{n=1}^\infty\frac{(-1)^{n+1}}{n}
\end{equation*}
is a multiple of the alternating harmonic series, and so converges.
...
=x^2.
\end{equation*}
By RaT, the power series converges absolutely if and only if $x^2<1$.
Therefore, the interval of absolute convergence is $(-1,1)$ and the radius of convergence is $R=1$.
At $x=\pm 1$,
\begin{equation*}
